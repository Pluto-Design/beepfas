...
export const offerCardFunctions = {
  en: {
    'one': ["Registration of the company and partners", "Running a company and consulting", "Annual settlement of the company and partners"],
    'two': ["Registration of the company and partners", "Running a company and consulting", "Full accounting service", "Representation before HMRC and Company House"],
  },
  pl: {
    'one': ["Rejestracja firmy i partnerów", "Prowadzenie firmy i konsultacje", "Roczne rozliczenie firmy i partnerów"],
    'two': ["Rejestracja firmy i partnerów", "Prowadzenie firmy i konsultacje", "Pełna obsługa księgowa", "Reprezentacja przed HMRC i Company House"],
  }
}

export const ui = {
  en: {
    'landing': "A professional Ashford-based accountancy firm that speaks your language!",
    'nav.about': 'About',
    'nav.offer': "Offer",
    'nav.contact': "Contact",
    'nav.blog': "Blog",
    ...
    'offer.phone': "Your Phone Number",
    'offer.message': "Your Message",
    'offer.send': "Send",
    'offer.interested': "Are you interested in our subscription?",
    "offer.leaveUsNumber": "Leave us your phone number - we'll call you back, agreeing on the details of your plan.",
  ...
  pl: {
    ...
    'offer.phone': "Twój numer telefonu",
    'offer.message': "Twoja wiadomość",
    'offer.send': "Wyślij",
    'offer.interested': "Interesuje Cię nasza subskrypcja?",
    "offer.leaveUsNumber": "Podaj nam swój numer telefonu - oddzwonimy do Ciebie, ustalając szczegóły Twojego planu.",
